...
INSERT INTO `Reservation` (`reservation start`, `table id`)
	VALUES
		...
		('2020-06-07 13:30:00', 29),
		('2020-06-13 10:00:00', 10),
...
UPDATE # Określa niedostępność 3 pozycji z menu
	`Menu`
		SET `available` = false
			WHERE `id` = 3;

UPDATE # Określa niedostępność 10 pozycji z menu
	`Menu`
		SET `available` = false
			WHERE `id` = 10;
